[
    {
            ...
            "logConfiguration": {
                ...
                "options": {
                    ...
                    "Labels": "{job=\"scribe-${environment}-internal-api\"}",
            ...
            "dnsServers": null,
            "mountPoints": [],
            "workingDirectory": "/internal-api/code",
            "secrets": [
                {
                ...
                {
                    "valueFrom": "arn:aws:ssm:${aws_region}:${account_id}:parameter/${environment}/airflow/SCRIBE_ALMIGHTY_FERNET_KEY",
                    "name": "SCRIBE_ALMIGHTY_FERNET_KEY"
                },
                {
        ...
        },
        {
            ...
            "systemControls": null,
            "privileged": null,
            "name": "internal-${environment}-api-log-router"
        }
]