 [
    {
            ...
            "logConfiguration": {
                ...
                "options": {
                    ...
                    "Labels": "{job=\"scribe-${environment}-airflow-scheduler\"}",
            ...
            "secrets": [
                ...
                {
                    "valueFrom": "arn:aws:ssm:${aws_region}:${account_id}:parameter/${environment}/airflow/SLACK_WEBHOOK_AIRFLOW_FAILURES",
                    "name": "AIRFLOW_VAR_SLACK_WEBHOOK_AIRFLOW_FAILURES"
                },
                {
                ...
                {
                    "valueFrom": "arn:aws:ssm:${aws_region}:${account_id}:parameter/${environment}/airflow/GITHUB_DEFAULT_CONN",
                ...
                {
                    "valueFrom": "arn:aws:ssm:${aws_region}:${account_id}:parameter/${environment}/airflow/CHAINBENCH_BIN_PATH",
                    "name": "AIRFLOW_VAR_CHAINBENCH_BIN_PATH"
                },
                {
                    "valueFrom": "arn:aws:ssm:${aws_region}:${account_id}:parameter/${environment}/airflow/SCRIBE_SERVICE_BIN_PATH",
                    "name": "AIRFLOW_VAR_SCRIBE_SERVICE_BIN_PATH"
                },
                {
                    "valueFrom": "arn:aws:ssm:${aws_region}:${account_id}:parameter/${environment}/airflow/GITHUB_POSTURE_POLICY_PATH",
                    "name": "AIRFLOW_VAR_GITHUB_POSTURE_POLICY_PATH"
                },
                {
            ...
            "systemControls": null,
            "privileged": null,
            "name": "airflow-${environment}-scheduler"
        },
        {
            "dnsSearchDomains": null,
            "environmentFiles": null,
            ...
            "systemControls": null,
            "privileged": null,
            "name": "scribe-${environment}-scheduler-log-router"
        }
]