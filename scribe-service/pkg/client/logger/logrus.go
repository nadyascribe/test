...
// LogrusNestedLogger is a wrapper for Logrus to enable nested logging configuration
// (loggers that always attach key-value pairs to all log entries)
...
func (l *LogrusLogger) SetDefaultFields(fields logrus.Fields) {
	l.DefaultFields = &fields
}

// Debugf takes a formatted template string and template arguments for the debug logging level.
func (l *LogrusLogger) Debugf(format string, args ...interface{}) {
	if l.LoggerEntry != nil {
...
func (l *LogrusLogger) Warnf(format string, args ...interface{}) {
	if l.LoggerEntry != nil {
		l.LoggerEntry.Warnf(format, args...)
	} else {
